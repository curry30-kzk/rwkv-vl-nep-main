...
def main():
    ...
    if nepa_model_type == "rwkv_nepa":
        ...
        from models.rwkv_nepa import RwkvNepaForImageClassification as NepaForImageClassification
    elif nepa_model_type == "vit_nepa":
        from models.vit_nepa import ViTNepaConfig as NepaConfig
        from models.vit_nepa import ViTNepaForImageClassification as NepaForImageClassification
    else:
        raise ValueError(
    ...
    model = NepaForImageClassification.from_pretrained(
