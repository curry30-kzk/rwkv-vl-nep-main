...
EXPERIMENT_NAME="rwkv-nepa-base-patch14-224-sft"
WANDB_PROJECT="RwkvNepa-SFT"

# You can point this to:
# - a local pretraining output dir (from scripts/pretrain/rwkv_nepa_b.sh), or
# - a converted classification checkpoint dir, or
# - a Hugging Face Hub repo id.
MODEL_NAME="${MODEL_NAME:-outputs/rwkv-nepa-base-patch14-224}"
