...
# Usage:
#   USE_GC=1 bash scripts/pretrain/nepa_l.sh
GC_ARGS=()
if [[ "${USE_GC:-0}" == "1" ]]; then
...
# Usage:
#   USE_DEEPSPEED=1 bash scripts/pretrain/nepa_l.sh
#   DEEPSPEED_CONFIG=configs/deepspeed/zero_stage1.json bash scripts/pretrain/nepa_l.sh
