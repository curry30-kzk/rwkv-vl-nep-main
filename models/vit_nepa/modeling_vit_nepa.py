...
# Local compatibility fallback for head pruning utils.
# Some transformers versions no longer export these helpers in the same place.
def find_pruneable_heads_and_indices(heads, n_heads, head_size, already_pruned_heads):
    """Find the heads and corresponding indices taking already-pruned heads into account."""
